...
export class ProduktvorlagenComponent extends Component<unknown, ProduktvorlagenController> {
  ...
  public render(): JSX.Element {
    return <Form onFinish={this.handleSubmit.bind(this)}>{/*<Content ctrl={this.ctrl} />*/}</Form>;
  }
}
