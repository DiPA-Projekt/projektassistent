...
import { ProcessNavigationController } from './controller';
...
@withRouter
export class ProcessNavigationComponent
  extends ReactComponent<unknown, ProcessNavigationController>
  implements GenericComponent
{
  public ctrl: ProcessNavigationController = new ProcessNavigationController();

  private navigationSubscription: Subscription = new Subscription();

  public constructor(props: unknown) {
    super(props);
    this.ctrl = new ProcessNavigationController(this.forceUpdate.bind(this));
  }
